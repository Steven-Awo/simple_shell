...
int is__chain(infor_t *, char *, size_t *);

void check__chain(infor_t *, char *, size_t *, size_t, size_t);

int replace__alias(infor_t *);

int replace__vars(infor_t *);

int replace__string(char **, char *);
